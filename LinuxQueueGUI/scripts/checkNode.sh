...
clusterC='192.168.0.12 192.168.0.13 192.168.0.14 192.168.0.16 192.168.0.17 192.168.0.18 192.168.0.19 192.168.0.11'
# 192.168.0.15
...
used=$( df | grep /mnt/Fsx/AWS | cut -c53-54 )
if [[ $used > 95 ]]
then  
